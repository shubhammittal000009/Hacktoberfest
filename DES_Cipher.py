print("Shubham Mittal 36814802717")
...
# User's Text to be encrypted
text = str(input("Enter Text to be Encrypted: "))

# Secret Key
key = "secret_k"

# number of bits in single chunk length
text_len = 8

# Dividing Length
chunks = [text[i:i+text_len] for i in range(0, len(text), text_len)]

# Defining Empty Encrypted_array
Encrypted_array = []

# Defining Empty Decrypted_array
Decrypted_array = []

for i in chunks:
    d = des()
    r = d.encrypt(key,i)
    Encrypted_array.append(r)
    r2 = d.decrypt(key,r)
    Decrypted_array.append(r2)


# Text Splited Strings:
print("Text Splited Strings: ", chunks)

# Encrypted Strings:
print("Encrypted Strings: ", Encrypted_array)

# Mapped strings with Encrypted Strings
print("Mapped strings with Encrypted Strings: ")
for i in range(len(chunks)):
    print(chunks[i] + " : " + Encrypted_array[i]) 

# Decrypted Strings:
print("Decrypted Strings: ", Decrypted_array)

# Final Decrypted String:

print("Final Decrypted String: ", *Decrypted_array, sep="")